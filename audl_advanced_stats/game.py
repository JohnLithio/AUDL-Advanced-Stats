...
def get_player_rates(df):
    ...
    dfout = df.assign(
        ...
        throws_pp=lambda x: x["throw_attempts"] / x["o_possessions"],
        ...
        throws_team_pct=lambda x: x["throw_attempts"] / x["throws_team"],
        ...
        for playerid in players:
            ...
            team_counts.append(
                [
                    ...
                    drops,
                    completions,
                    completions + throwaways + stalls,  # throw attempts
                    stalls,
                    goals,
                    blocks,
                    callahans,
